...
class OtbDataTable extends DataTable
{
    ...
    public function query(Otb $model): QueryBuilder
    {
        return $model->newQuery()->with('oltPort');
    }

    public function html(): HtmlBuilder
    {
        return $this->builder()
            ->setTableId('otb-table')
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('nama_otb')->title('Nama OTB'),
            Column::make('olt_port_id')->title('Port OLT'),
